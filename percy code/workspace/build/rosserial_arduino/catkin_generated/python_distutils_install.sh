...
echo_and_run cd "/home/gdp31/GDP31/workspace/src/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/gdp31/GDP31/workspace/src/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/gdp31/GDP31/workspace/build/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
