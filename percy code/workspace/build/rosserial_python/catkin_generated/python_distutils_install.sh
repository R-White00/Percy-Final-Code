...
echo_and_run cd "/home/gdp31/GDP31/workspace/src/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/gdp31/GDP31/workspace/src/rosserial_python/setup.py" \
     \
    build --build-base "/home/gdp31/GDP31/workspace/build/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
