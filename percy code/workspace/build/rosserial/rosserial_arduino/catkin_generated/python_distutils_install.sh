...
echo_and_run cd "/home/gdp31/GDP31/workspace/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/home/gdp31/GDP31/workspace/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/gdp31/GDP31/workspace/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
