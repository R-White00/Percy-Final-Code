...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /home/gdp31/GDP31/workspace/src/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /home/gdp31/GDP31/workspace/devel)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /home/gdp31/GDP31/workspace/install)
...
if(NOT "/home/gdp31/GDP31/workspace/devel/include;/home/gdp31/GDP31/workspace/src/diff_drive_controller/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/gdp31/GDP31/workspace/devel/include;/home/gdp31/GDP31/workspace/src/diff_drive_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gdp31/GDP31/workspace/src/diff_drive_controller/${idir}'.  ${_report}")
    endif()
