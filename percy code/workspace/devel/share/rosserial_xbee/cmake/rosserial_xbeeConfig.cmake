...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_xbee_SOURCE_PREFIX /home/gdp31/GDP31/workspace/src/rosserial/rosserial_xbee)
  set(rosserial_xbee_DEVEL_PREFIX /home/gdp31/GDP31/workspace/devel)
  ...
  set(rosserial_xbee_INSTALL_PREFIX /home/gdp31/GDP31/workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_xbee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gdp31/GDP31/workspace/src/rosserial/rosserial_xbee/${idir}'.  ${_report}")
    endif()
